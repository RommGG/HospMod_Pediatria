          ...
          <template v-slot:body>
            <div class="iq-email-list">
              <b-button
                variant="primary"
                size="lg"
                class="font-size-16 p-3 mb-3 btn-block w-100"
                block
              ...
              <div class="iq-email-ui nav flex-column nav-pills" role="tablist">
                ...
                >
                  <a href="index.html"
                    ><i class="ri-mail-line"></i>Inbox<span
              ...
              <ul class="iq-email-ui iq-email-label">
                <li>
                  <a href="#"
                    ><i class="ri-focus-fill text-primary"></i>Personal</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="ri-focus-fill text-danger"></i>Company</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="ri-focus-fill text-success"></i>Important</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a href="#"
                    ><i class="ri-focus-fill text-warning"></i>Private</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="ri-add-circle-line"></i>Add New Labels</a
                  >
                </li>
              </ul>
