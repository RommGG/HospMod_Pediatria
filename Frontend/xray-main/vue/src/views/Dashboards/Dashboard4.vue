        ...
        <b-row>
          <b-col md="6" lg="3">
            <iq-card>
              <template v-slot:body>
                <div
                  class="iq-progress-bar progress-bar-vertical iq-bg-primary"
                >
          ...
          <b-col md="6" lg="3">
            <iq-card>
              <template v-slot:body>
                <div
                  class="iq-progress-bar progress-bar-vertical iq-bg-warning"
                >
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <div class="iq-details">
              ...
              <div class="percentage float-end text-primary">
                95 <span>%</span>
              </div>
            ...
            <div class="iq-details mt-4">
              ...
              <div class="percentage float-end text-warning">
                75 <span>%</span>
              </div>
              <div class="iq-progress-bar-linear d-inline-block w-100">
                <div class="iq-progress-bar">
            ...
            <div class="iq-details mt-4">
              ...
              <div class="percentage float-end text-success">
                55 <span>%</span>
              </div>
              <div class="iq-progress-bar-linear d-inline-block w-100">
                <div class="iq-progress-bar">
            ...
            <div class="iq-details mt-4">
              ...
              <div class="percentage float-end text-danger">
                25 <span>%</span>
              </div>
              <div class="iq-progress-bar-linear d-inline-block w-100">
                <div class="iq-progress-bar">
...
export default {
  name: "DashboardFour",
  components: { IqCard, ApexChart, AmChart, FlatPicker, CountUp },
  data() {
    return {
      config: {
        dateFormat: "Y-m-d",
