        ...
        <template v-slot:body>
          <div class="stepwizard mt-4">
            <ul class="stepwizard-row setup-panel">
              ...
              >
                <a href="#cpnfirm-data" class="btn btn-default disabled active">
                    ...
                    <b-col md="6">
                      <b-form-group label="Confirm Password: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.cnfm_password }"
                        />
                        <div class="invalid-feedback">
                    ...
                    <b-col md="6">
                      <b-form-group label="Alternate Contact Number: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.Alt_ContactNO }"
                        />
                        <div class="invalid-feedback">
                    ...
                    <b-col md="6">
                      <b-form-group label="Company Url: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.Company_URL }"
                        />
                        <div class="invalid-feedback">
                    ...
                    <b-col md="6">
                      <b-form-group label="Company Mail Id: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.Company_Mail }"
                        />
                        <div class="invalid-feedback">
                    ...
                    <b-col md="6">
                      <b-form-group label="Account No: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.Account_No }"
                        />
                        <div class="invalid-feedback">
                    ...
                    <b-col md="6">
                      <b-form-group label="Bank Branch Name: *">
                        <Field
                          ...
                          :rules="isRequire"
                          :class="{ 'is-invalid': errors.Bank_Branch }"
                        />
                        <div class="invalid-feedback">
