            ...
            <template v-slot:body>
              ...
              <b-form-group label="User Role:" label-for="selectuserrole">
                <Field
                  ...
                  v-model="user.role"
                  :options="roles"
                  class="form-control form-select py-0"
                  name="userRole"
                  :rules="isRequire"
          ...
          <iq-card>
            ...
            <template v-slot:body>
              <div class="new-user-info">
                <b-row>
                  ...
                  >
                    <Field
                      ...
                      :rules="isRequire"
                      :class="{ 'is-invalid': errors.DepartmentName }"
                    ></Field>
                    <div class="invalid-feedback">
                  ...
                  >
                    <Field
                      as="select"
                      :options="countries"
                      class="form-control form-select py-0 mb-2"
                ...
                <div class="checkbox">
                  <label
                    ><input class="me-2 mb-4" type="checkbox" />Enable
                    Two-Factor-Authentication</label
                  >
                </div>
                <b-button variant="primary mt-2" type="submit"
