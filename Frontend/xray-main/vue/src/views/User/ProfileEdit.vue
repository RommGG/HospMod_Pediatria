          ...
          <iq-card body-class="p-0">
            <template v-slot:body>
              ...
              <div class="iq-edit-list">
                <ul
                  class="nav nav-tabs iq-edit-profile d-flex nav-pills"
                  id="myTab"
                  role="tablist"
                >
        ...
        <b-col lg="12">
          <div class="iq-edit-list-data">
            <div class="tab-content" id="pills-tabContent-2">
                  ...
                  <template v-slot:body>
                    ...
                    <b-row align-v="center">
                      ...
                      <b-form-group
                        ...
                        label-class="d-block"
                      >
                        <b-form-radio inline v-model="user.gender" value="male"
                          >Male</b-form-radio
                        >
                        <b-form-radio
                          inline
                    ...
                    <b-button type="submit" variant="primary" class="me-2 mt-3"
                      >Submit</b-button
                    >
                    <b-button
                      type="reset"
                      variant="none"
                      class="btn iq-bg-danger mt-3"
                      >Cancel</b-button
                    >
                  </template>
                </iq-card>
              </div>
              <div class="tab-pane fade" aria-labelledby="''" id="chang-pwd">
                <iq-card>
                  <template v-slot:headerTitle>
                  ...
                  <template v-slot:body>
                    <b-form-group>
                      ...
                      <b-link href="javascripe:void();" class="float-end mb-2"
                    ...
                    >
                      <ValidationProvider
                        name="Password"
                        rules="confirmed:verify_password"
                      >
                        <b-form-input
              ...
              <div class="tab-pane fade" aria-labelledby="''" id="emailandsms">
                <iq-card>
                  <template v-slot:headerTitle>
                  ...
                  <template v-slot:body>
                    <div class="form-group row align-items-center">
                      ...
                      <div class="col-md-9 custom-control custom-switch">
                        ...
                        />
                        <label
                          class="custom-control-label ms-3"
...
export default {
  ...
  data() {
    return {
      user: {
        ...
        password: "",
        address1:
          "37 Cardinal Lane Petersburg, VA 23803 United States of America Zip Code: 85001",
        address2: "",
        company_name: "",
  ...
  methods: {
    onSubmit() {
      ...
      xray.showSnackbar("success", "User has been added successfully.");
