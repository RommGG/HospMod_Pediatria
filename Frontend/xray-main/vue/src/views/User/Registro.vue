          ...
          <div class="col-sm-12">
            <b-alert :show="true" variant="success">
              <div class="iq-alert-text">
                ...
                <p style="text-align: center;">Se ha realizado con exito el nuevo registro.</p>
              ...
              <div class="new-user-info">
                <b-row>
                  <b-form-group class="col-md-6" label="Nombre Completo Padre:" label-for="PadreName">
                    <Field type="text" placeholder="Nombre" class="form-control mb-2" name="FirstName"
                      :rules="isRequire" :class="{ 'is-invalid': errors.FirstName }" />
                  </b-form-group>


                  <b-form-group class="col-md-6" label="Nombre Completo Madre:" label-for="MadreName">
                    <Field type="text" class="form-control mb-2" placeholder="Nombre" :rules="isRequire" name="LastName"
                  ...
                  <b-form-group class="col-md-6" label="Fecha de Nacimiento:" label-for="add1">
                    <Field class="form-control mb-2" type="date" name="Address1" placeholder="Fecha" :rules="isRequire"
                  ...
                  <b-form-group class="col-md-4" label="Peso:" label-for="dname">
                    <Field class="form-control mb-2" type="text" name="DepartmentName" id="dname" placeholder="Peso"
                      :rules="isRequire" :class="{ 'is-invalid': errors.DepartmentName }">
                    </Field>
                  </b-form-group>
                  ...
                  <b-form-group class="col-md-4" label="Temperatura:" label-for="mobno">
                    <Field class="form-control mb-2" type="number" placeholder="Temperatura (°C)" name="mobno"
                      :rules="isRequire" :class="{ 'is-invalid': errors.mobno }"></Field>
                  </b-form-group>
                  ...
                  <b-form-group class="col-md-4" label="Frecuencia Cardiaca:" label-for="mobno">
                    <Field class="form-control" type="text" placeholder="Frecuencia Cardiaca" name="Alt_ContactNO"
                      :rules="isRequire" :class="{ 'is-invalid': errors.Alt_ContactNO }"></Field>
                  </b-form-group>



                  <b-form-group class="col-md-6" label="Presion Arterial Sistolica:" label-for="uname">
                    <Field class="form-control mb-2" type="text" placeholder="Presion Arterial Sistolica" name="Email"
                      :rules="isRequire" :class="{ 'is-invalid': errors.Email }"></Field>
                  </b-form-group>
                  ...
                  <b-form-group class="col-md-12" label="Email de Contacto:" label-for="emai">
                    <Field class="form-control mb-2" type="email" name="email" id="email"
                      placeholder="Email de Contacto" :rules="isRequire" :class="{ 'is-invalid': errors.email }">
                    </Field>
                  </b-form-group>
                  ...
                  <b-form-group class="col-md-12" label="Observaciones:" label-for="city">
                    <Field class="form-control mb-2" type="text" name="city" id="city" placeholder="Observaciones"
                      :rules="isRequire" :class="{ 'is-invalid': errors.city }"></Field>
                  </b-form-group>
                </b-row>
                <hr />
