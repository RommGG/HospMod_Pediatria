<template>
  <b-container fluid>
    <b-row>
      <b-col lg="12">
        <iq-card>
          <template v-slot:headerTitle><h4>Docters List</h4> </template>
        </iq-card>
      </b-col>
      ...
      doctors: [
        {
          ...
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor non erat non gravida. In id ipsum consequat",
        },
        {
          name: "Dr. Paul Molive",
          specialist: "Heart Surgeons",
        ...
        {
          name: "Dr. Sue Vaneer",
          specialist: "Orthopedics Special",
          image: require("../../assets/images/user/15.jpg"),
          website: "www.demo.com",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor non erat non gravida. In id ipsum consequat",
