<template>
  <b-container fluid>
    <b-row>
      ...
      <b-col sm="3">
        ...
        >
          ...
          <p>
            It is a long established fact that a the readable content of a page
      ...
      <b-col sm="6">
        <b-card title="Special title treatment" class="iq-mb-3">
          <b-card-text
            ...
            layout.</b-card-text
          >
          <b-button href="#" block variant="btn btn-primary w-100"
    ...
    <b-row>
      ...
      <b-col lg="6">
        <b-card no-body class="iq-mb-3">
          <b-row class="no-gutters flex-row-reverse">
            <b-col md="4">
              <b-card-img
    ...
    <b-row>
      ...
      <b-col lg="4">
        ...
        >
          <b-card-title class="text-secondary"
            >Secondary card title</b-card-title
          >
          <blockquote class="blockquote mb-0">
      ...
      <b-col lg="4">
        <b-card text-variant="success" border-variant="success" class="iq-mb-3">
          ...
          <blockquote class="blockquote mb-0">
            <p class="font-size-14 text-success">
              Some quick example text to build on the card title text to build
              on the card title and make up the bulk of the card's content.
            </p>
          </blockquote>
      ...
      <b-col lg="4">
        <b-card text-variant="danger" border-variant="danger" class="iq-mb-3">
          ...
          <blockquote class="blockquote mb-0">
            <p class="font-size-14 text-danger">
              Some quick example text to build on the card title text to build
              on the card title and make up the bulk of the card's content.
            </p>
          </blockquote>
      ...
      <b-col lg="4">
        <b-card text-variant="warning" border-variant="warning" class="iq-mb-3">
          ...
          <blockquote class="blockquote mb-0">
            <p class="font-size-14 text-warning">
              Some quick example text to build on the card title text to build
              on the card title and make up the bulk of the card's content.
            </p>
          </blockquote>
      ...
      <b-col lg="4">
        <b-card text-variant="info" border-variant="info" class="iq-mb-3">
          ...
          <blockquote class="blockquote mb-0">
            <p class="font-size-14 text-info">
              Some quick example text to build on the card title text to build
              on the card title and make up the bulk of the card's content.
            </p>
          </blockquote>
