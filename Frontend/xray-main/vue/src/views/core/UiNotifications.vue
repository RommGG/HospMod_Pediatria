...
&lt;/b-toast&gt;
            ...
            >
              <div class="toast-header">
                ...
                <button
                  v-on:click="toast_fade = !toast_fade"
                  type="button"
...
&lt;/b-toast&gt;
            ...
            <div
              class="toast fade mb-3"
              :class="{ show: toast_fade_2 }"
              role="alert"
              aria-live="assertive"
              aria-atomic="true"
            >
...
&lt;/b-toast&gt;
            ...
            <div
              class="toast fade mb-3 bg-primary"
              :class="{ show: toast_fade_9 }"
              role="alert"
              aria-live="assertive"
              aria-atomic="true"
            >
              <div class="toast-header bg-primary">
                ...
                <strong class="me-auto">Bootstrap</strong>
                <small class="text-muted text-white">11 mins ago</small>
                <button
                  v-on:click="toast_fade = !toast_fade"
                  type="button"
                  class="btn-close ms-2"
            ...
            <div
              class="toast fade bg-success"
              :class="{ show: toast_fade_10 }"
              role="alert"
              aria-live="assertive"
              aria-atomic="true"
            >
